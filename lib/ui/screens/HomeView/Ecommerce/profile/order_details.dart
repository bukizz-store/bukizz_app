                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            ReusableText(text: '${orderData.selectedOrderModel.cartLength} items', fontSize: 12),
                            SizedBox(height: dimensions.height10,),
                            SizedBox(
                            ...
                            SizedBox(height: dimensions.height10,),
                            ReusableText(text: 'Ordered On: ${orderData.selectedOrderModel.orderDate.substring(0 , 10)}', fontSize: 12,color: Color(0xFFA5A5A5),fontWeight: FontWeight.w500,),
                          ],
                        ),
                      ],
                    ),
              ...
              Container(
                ...
                child:  Row(
                  ...
                  children: [
                    ...
                    ReusableText(text: '₹${orderData.selectedOrderModel.saleAmount}', fontSize: 16,color: Color(0xFF121212),fontWeight: FontWeight.w500,),
                  ],
                ),
              ),
              if(dropDown)
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ReusableText(text: '₹${orderData.selectedOrderModel.totalAmount}', fontSize: 12,color: Color(0xFF121212),fontWeight: FontWeight.w500, )
                        ],
                      ),
                      SizedBox(height: dimensions.height8,),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ReusableText(text: '-₹${orderData.selectedOrderModel.totalAmount - orderData.selectedOrderModel.saleAmount}', fontSize: 12,color: Color(0xFF038B10),fontWeight: FontWeight.w500)
                        ],
                      ),
      ...
      productData.forEach((product, setData) {
        setData.forEach((set, streamData) {
          streamData.forEach((stream, data) {
            ProductModel productModel = orderData.orderedProduct.where((element) => element.productId == product).first;
                      ...
                      children: [
                        Row(
                          children: [
                            ReusableText(text: 'Your order is', fontSize: 16,color: Color(0xFF444444),fontWeight: FontWeight.w700,),
                            SizedBox(width: dimensions.width10/2,),
                            ReusableText(text: data[2], fontSize: 16,color: Color(0xFF444444),fontWeight: FontWeight.w700,),
                          ],
                        ),
                        SizedBox(height: dimensions.height8*2,),
                        ReusableText(text: '1 Day ago', fontSize: 12,fontWeight: FontWeight.w500,color: Color(0xFF7A7A7A),),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: dimensions.height16,),
                                ReusableText(text: '₹ $price', fontSize: 12,fontWeight: FontWeight.w700,color: Color(0xFF121212),)
                              ],
                            ),
