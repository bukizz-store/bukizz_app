...
class _OrderScreenState extends State<OrderScreen> {
  ...
  // Helper method to calculate expected delivery date (adds 5-7 business days)
  String _getExpectedDeliveryDate(String orderDateString) {
    try {
      ...
      return orderDateString.substring(0, 10);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MyOrders>(builder: (context, orderData, child) {
      return orderData.isOrdersLoaded
          ? Scaffold(
              appBar: AppBar(
                leading: IconButton(
                  icon: Icon(
