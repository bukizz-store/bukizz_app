    ...
    return Consumer<OrderQueryRepository>(builder: (context, queryData, child) {
      return Scaffold(
                  ...
                  children: [
                    ...
                    Container(
                      constraints: BoxConstraints(
                          maxWidth: dimensions.width342,
                          maxHeight: dimensions.height40),
                      decoration: ShapeDecoration(
                        color: Color(0xFFF9F9F9),
                        shape: RoundedRectangleBorder(
                          side:
                              BorderSide(width: 0.50, color: Color(0xFFD6D6D6)),
                      ...
                      child: DropdownButtonFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.only(
                              ...
                              right: dimensions
                                  .height10), // Adjust vertical padding
                        ),
                      ),
                    ),
                    SizedBox(
                        ...
                        decoration: InputDecoration(
                          ...
                          border: OutlineInputBorder(
                            ...
                            borderSide: BorderSide(
                                width: 0.5, color: Color(0xFFD6D6D6)),
                          ),
                          contentPadding: EdgeInsets.all(12),
                          filled:
                              true, // Fill the container with background color
        ...
        bottomNavigationBar: SafeArea(
          child: Padding(
            padding: EdgeInsets.symmetric(
                horizontal: dimensions.width10, vertical: dimensions.width24),
            child: ReusableElevatedButton(
                ...
                onPressed: () {
                  if (dropdownValue == null || messageController.text.isEmpty) {
                    ...
                    queryData.setOrderQuery(
                        messageController.text, dropdownValue!, context);
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const TickScreen(
                                  text: "Query Raised Successfully!",
                                  secondaryText: "We will get back to you soon",
                                )));
                  }
                },
