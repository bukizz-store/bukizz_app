...
// import 'package:upi_india/upi_india.dart'; // commented out to disable UPI integration
...
class _Checkout3State extends State<Checkout3> {
  ...
  void setState(VoidCallback fn) {
    ...
    super.setState(fn);
    // UPI SDK usage commented out — do not call provider methods when UPI integration is disabled
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            CheckoutProcessWidget(currentStep: 3),
            SizedBox(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ReusableText(
                            text:
                                '₹${cartData.getSalePrice + cartData.getDelivery}',
                            fontSize: 16,
                            color: Color(0xFF121212),
                            fontWeight: FontWeight.w500,
                          )
                ...
                child: InkWell(
                  onTap: () {
                    showCustomAboutDialog(context, () {
                      context.read<OrderViewRespository>().setOrderModelData(
                          "cod_${generateTransactionId()}", context);
                      Navigator.push(
                          context,
                          MaterialPageRoute(
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
          ...
          title: Center(
            child: ReusableText(
              text: 'Confirm Cash on Delivery Option',
              fontSize: 16,
              fontWeight: FontWeight.w700,
              color: Color(0xFF121212),
            ),
