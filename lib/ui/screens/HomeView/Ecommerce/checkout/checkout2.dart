                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ReusableText(
                                    text:
                                        "${orderDetail.getUserAddress.houseNo}, ${orderDetail.getUserAddress.street}, ${orderDetail.getUserAddress.city}, ${orderDetail.getUserAddress.state}, ${orderDetail.getUserAddress.pinCode}",
                                    fontSize: 14,
                                    height: 0,
