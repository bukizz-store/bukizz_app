...
class _SelectLocationState extends State<SelectLocation> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                    borderRadius: BorderRadius.circular(16),
                                    child: Image.asset(
                                      'assets/onboarding/city${index + 1}.jpeg',
                                      fit: BoxFit.cover,
      ...
      bottomNavigationBar: selectedCity == ''
          ? null
          : SafeArea(
              child: Padding(
                ...
                child: ReusableElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      context
                          .read<UpdateUserData>()
                          .saveLocationSetToSharedPreferences(selectedCity);
                      context.read<SchoolDataProvider>().loadData(context).then(
                          (value) =>
                              debugPrint("School Data Loaded Successfully"));
