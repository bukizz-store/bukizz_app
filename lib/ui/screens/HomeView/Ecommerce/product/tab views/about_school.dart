        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.all(dimensions.width16),
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.all(Radius.circular(10)),
                image: DecorationImage(
                  image: CachedNetworkImageProvider(schoolData.selectedSchool.banner),
            ...
            Container(
              ...
              child:  Column(
                ...
                children: [
                  ...
                  SizedBox(height: dimensions.height8*2.3,),
                  SizedBox(
                    width: double.infinity,
                    child: Text(
                      schoolData.selectedSchool.aboutUs,
