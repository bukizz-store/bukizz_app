                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ReusableText(
                                    text:
                                        'Size: ${value.selectedUniform.stream[value.getSelectedStreamDataIndex].name}',
                                    fontSize: 16,
                                    fontWeight: FontWeight.w700,
                                  ),
                                  SizedBox(
                              ...
                              Container(
                                  ...
                                  child: ListView.builder(
                                      scrollDirection: Axis.horizontal,
                                      itemCount:
                                          value.selectedUniform.stream.length,
                                      itemBuilder: (context, index) {
                        ...
                        isDeliverable
                            ...
                            : Row(
                                children: [
                                  ...
                                  ReusableText(
                                    text:
                                        'Delivery Unavailable at this Pin code',
                                    fontSize: 14,
                                    fontWeight: FontWeight.w500,
                                    color: AppColors.red,
                                  )
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ReusableText(
                                text:
                                    productAdded ? 'Go to Cart' : 'Add to Cart',
                                fontSize: 16,
                                height: 0.11,
                                fontWeight: FontWeight.w700,
